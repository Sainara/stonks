...
//        }
    ...
    func buildTabs() {
        ...
        viewControllers = [
            createTab(vc: UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "main"), imageName: "feed", tag: 0),
            //createTab(vc: MainDocsViewController(), imageName: "docs", tag: 0),
            createTab(vc: PortfelViewController(), imageName: "fav", tag: 1),
