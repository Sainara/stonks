...
public class TommyTextView: UITextView {
    ...
    func initializeUI() {
        ...
        placeholderView.font = Fonts.standart.gilroyMedium(ofSize: 17)
    ...
    @objc private func textViewDidChange(notification: Notification) {
        guard let textView = notification.object as? TommyTextView else {
            return
        }
    ...
    @objc private func textViewDidChange(_ textView: TommyTextView) {
